...
dep_label_mappings = {'det': ('det',),
    ...
    'cop': ('cop','null'),
    'xcomp': ('xcomp',),
    'compound:prt': ('compund','mod'),
    'aux:pass': ('aux','null'),
    'nsubj:pass': ('nsubj:pass','subj:pass'),
    'expl': ('expl','null'),
    'acl:relcl': ('acl','mod'),
    'appos': ('appos','mod'),
    'parataxis': ('parataxis','mod'),
    'obl:agent': ('obl:agent', 'obl'),
    'ccomp': ('ccomp','obj'),
    'fixed': ('fixed','mod'),
    'flat': ('fixed','mod'),
    'obl:tmod': ('obl',),
